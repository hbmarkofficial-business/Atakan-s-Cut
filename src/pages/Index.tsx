  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Mönchengladbach | Atakan's Cut</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Atakan's Cut in Mönchengladbach für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Atakan's Cut | Premium Barbershop Mönchengladbach" />
        <meta
        ...
        <meta name="twitter:title" content="Atakan's Cut | Premium Barbershop Mönchengladbach" />
        <meta
